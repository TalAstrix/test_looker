view: county_natality_by_mother_race {
  sql_table_name: `public_ds.county_natality_by_mother_race`
    ;;
  ...
  dimension: mothers_single_race {
    type: string
    description: "Mother's Single Race 6"
    sql: ${TABLE}.Mothers_Single_Race ;;
  }

  dimension: mothers_single_race_code {
    type: string
    description: "Mother's Single Race 6 Code"
