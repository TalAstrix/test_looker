view: county_natality_by_father_race {
  sql_table_name: `public_ds.county_natality_by_father_race`
    ;;
  ...
  dimension: fathers_single_race {
    type: string
    description: "Father's Single Race 6"
    sql: ${TABLE}.Fathers_Single_Race ;;
  }

  dimension: fathers_single_race_code {
    type: string
    description: "Father's Single Race 6 Code"
