view: county_natality_by_abnormal_conditions {
  sql_table_name: `public_ds.county_natality_by_abnormal_conditions`
    ;;

  dimension: abnormal_conditions_checked_desc {
    type: string
    description: "Abnormal Conditions Checked"
    sql: ${TABLE}.Abnormal_Conditions_Checked_Desc ;;
  }

  dimension: abnormal_conditions_checked_yn {
    type: number
    description: "Abnormal Conditions Checked Code"
    sql: ${TABLE}.Abnormal_Conditions_Checked_YN ;;
  }
